  ...
  return (
    <figure
      className={cn(
        ...
        'transform-gpu bg-white backdrop-blur-md [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_4px_5px_3px_rgba(157,141,255),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)]'
      )}
    >
      <div className="flex flex-row items-center gap-3 min-h-16">
        ...
        <div className=" overflow-hidden">
          <span className="text-xl md:text-2xl text-[#5C3095] font-semibold">
            {data}{' '}
          </span>
