...
const DentalCare: React.FC<DentalCareProps> = ({ Posters, ListItems, Title }) => {
  return (
    <div className='p-7 flex flex-col gap-4 md:gap-10 bg-[#DAD9FF]'>
      <h1 className='text-center bg-[#C1B6FD] text-[#522987] font-semibold text-sm md:text-3xl py-2 px-4 md:px-10 rounded-sm w-fit mx-auto'>{Title}</h1>
...
{ (Title==="ALL SMILES DENTAL CARE" || Title==="BOW RIVER DENTAL") &&
    <div>
        ...
        We <span className='text-[#3A2896] font-bold'>Achieved </span>All This Within <span className='text-[#3A2896] font-bold'>15 DAYS </span> Of Their <span className='text-[#3A2896] font-bold'>Marketing Campaign </span>
      </div>
